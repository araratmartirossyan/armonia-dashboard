...
class ApiClient {
  ...
  async activateLicense(id: string): Promise<License> {
    const response = await this.client.patch<{ message: string; license: License }>(`/licenses/${id}/activate`);
    return response.data.license;
  }

  async deactivateLicense(id: string): Promise<License> {
    const response = await this.client.patch<{ message: string; license: License }>(`/licenses/${id}/deactivate`);
    return response.data.license;
  }
  ...
  async updateKnowledgeBase(id: string, data: UpdateKnowledgeBaseRequest): Promise<KnowledgeBase> {
    const response = await this.client.patch<KnowledgeBase>(`/knowledge-bases/${id}`, data);
    return response.data;
  }
  ...
  async updateAIConfiguration(data: UpdateAIConfigRequest): Promise<AIConfiguration> {
